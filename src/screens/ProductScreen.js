...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://electrocity2022.herokuapp.com/api/products/slug/${slug}`);
  ...
  const addToCartHandler = async () => {
    ...
    const { data } = await axios.get(`https://electrocity2022.herokuapp.com/api/products/${product._id}`);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `https://electrocity2022.herokuapp.com/api/products/${product._id}/reviews`,
